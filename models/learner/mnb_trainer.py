...
DB_PATH = "features.db"
MODEL_PATH = "models/learner/mnb_model.joblib"
...
def train_multinomial_nb():
    ...
    joblib.dump(tfidf, "models/learner/tfidf_vectorizer.joblib")
    ...
    print("[INFO] Multinomial Naive Bayes training completed successfully.")
